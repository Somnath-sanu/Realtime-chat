...
export const create = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    const requestAlredySent = await ctx.db
      .query("requests")
    ...
    console.log({ requestAlredyReceived });
...
export const accept = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    await ctx.db.delete(request._id); //TODO: commit this if this cause trouble
  },
});
